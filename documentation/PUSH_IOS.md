...
## Setup process
 ...
 3. [Configuring Exponea to send push notifications](#4-configuring-exponea-to-send-push-notifications)
 4. [Authorizing the application for receiving push notifications](#5-authorizing-for-receiving-push-notifications)
 5. [Rich push notifications](#6-rich-push-notifications)(optional)
...
## 3. Configuring Exponea to send push notifications
...
## 4. Authorizing for receiving push notifications
