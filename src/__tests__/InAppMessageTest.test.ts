...
describe('InApp messages API', () => {
  ...
  test('track action with nulls - nonrich', async () => {
    ...
    expect(JSON.parse(mockExponea.lastArgumentsJson)).toStrictEqual(
      JSON.parse(
        TestUtils.readJsonFile('./src/test_data/in-app-click-nulls.json')
      )
    );
  });
  ...
  test('track action with action - nonrich', async () => {
    ...
    expect(JSON.parse(mockExponea.lastArgumentsJson)).toStrictEqual(
      JSON.parse(
        TestUtils.readJsonFile('./src/test_data/in-app-click-minimal.json')
      )
    );
  });
  ...
  test('track close without action - nonrich', async () => {
    ...
    expect(JSON.parse(mockExponea.lastArgumentsJson)).toStrictEqual(
      JSON.parse(
        TestUtils.readJsonFile('./src/test_data/in-app-close-minimal.json')
      )
    );
  });
  ...
  test('track close with action - nonrich', async () => {
    ...
    expect(JSON.parse(mockExponea.lastArgumentsJson)).toStrictEqual(
      JSON.parse(
        TestUtils.readJsonFile('./src/test_data/in-app-close-complete.json')
      )
    );
  });
  ...
  test('invoke in-app callback for shown message - nonrich', async () => {
    ...
    mockExponea.simulateEmit(
      'inAppAction',
      TestUtils.readJsonFile('./src/test_data/in-app-shown.json')
    );
  ...
  test('invoke in-app callback for error report without message', async () => {
    ...
    mockExponea.simulateEmit(
      'inAppAction',
      TestUtils.readJsonFile('./src/test_data/in-app-error-minimal.json')
    );
    expect(messageSlot.isCaptured).toBe(true);
  ...
  test('invoke in-app callback for error report with message - nonrich', async () => {
    ...
    mockExponea.simulateEmit(
      'inAppAction',
      TestUtils.readJsonFile('./src/test_data/in-app-error-complete.json')
    );
    expect(messageSlot.isCaptured).toBe(true);
    expect(messageSlot.captured?.id).toBe('5dd86f44511946ea55132f29');
    expect(errorSlot.isCaptured).toBe(true);
  ...
  test('track action with nulls - richstyle', async () => {
    ...
    expect(JSON.parse(mockExponea.lastArgumentsJson)).toStrictEqual(
      JSON.parse(
        TestUtils.readJsonFile(
          './src/test_data/in-app-click-nulls-richstyle.json'
        )
      )
    );
  });
  ...
  test('track action with action - richstyle', async () => {
    ...
    expect(JSON.parse(mockExponea.lastArgumentsJson)).toStrictEqual(
      JSON.parse(
        TestUtils.readJsonFile(
          './src/test_data/in-app-click-minimal-richstyle.json'
        )
      )
    );
  });
  ...
  test('track close without action - richstyle', async () => {
    ...
    expect(JSON.parse(mockExponea.lastArgumentsJson)).toStrictEqual(
      JSON.parse(
        TestUtils.readJsonFile(
          './src/test_data/in-app-close-minimal-richstyle.json'
        )
      )
    );
  });
  ...
  test('track close with action - richstyle', async () => {
    ...
    expect(JSON.parse(mockExponea.lastArgumentsJson)).toStrictEqual(
      JSON.parse(
        TestUtils.readJsonFile(
          './src/test_data/in-app-close-complete-richstyle.json'
        )
      )
    );
  });
  ...
  test('invoke in-app callback for shown message - richstyle', async () => {
    ...
    mockExponea.simulateEmit(
      'inAppAction',
      TestUtils.readJsonFile('./src/test_data/in-app-shown-richstyle.json')
    );
    expect(messageSlot.isCaptured).toBe(true);
    expect(messageSlot.captured.id).toBe('5dd86f44511946ea55132f29');
  });
  ...
  test('invoke in-app callback for error report with message - richstyle', async () => {
    ...
    mockExponea.simulateEmit(
      'inAppAction',
      TestUtils.readJsonFile(
        './src/test_data/in-app-error-complete-richstyle.json'
      )
    );
    expect(messageSlot.isCaptured).toBe(true);
    expect(messageSlot.captured?.id).toBe('5dd86f44511946ea55132f29');
