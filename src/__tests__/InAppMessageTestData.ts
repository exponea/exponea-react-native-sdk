import type { InAppMessage } from '../ExponeaType';
  ...
  static buildInAppMessage(options?: {
    ...
    if (options?.messageType == 'freeform') {
      ...
      payload = {
        image_url:
          options?.imageUrl ??
          'https://i.ytimg.com/vi/t4nM1FoUqYs/maxresdefault.jpg',
        ...
        buttons: [
          {
            ...
            button_font_url:
              'https://webpagepublicity.com/free-fonts/x/Xtrusion%20(BRK).ttf',
            button_width: 'hug',
